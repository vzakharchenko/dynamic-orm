...
public class QTimeBuilder extends QSizeColumnBuilderImpl<QSizeColumnImpl,
        QSizeColumnBuilder<QTableColumn, ?>> {


    public QTimeBuilder(QTableColumnContext qTableColumn, String columnName) {
    ...
    protected void createColumn(QDynamicTable dynamicTable, Database database) {
        dynamicTable
                .createTimeColumn(database, columnType);
    }
}
